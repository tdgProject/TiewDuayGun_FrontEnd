<template>
  <div id="nav" class="text-center bg-gray-500 h-12">
    ...
    <router-link to="/List" id="List">List</router-link>
  ...
  <router-view />
      <div class="bg-gray-900 py-5 bg-gray-700 text-center text-white">
    <footer class="flex flex-wrap items-center justify-between p-3 m-auto bottom-0  w-full">
