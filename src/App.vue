    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between py-4">
        ...
        <div class="hidden sm:flex sm:items-center">
          ...
          <a href="/List/All/1" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">List</a>
        ...
        <div class="hidden sm:flex sm:items-center">
          <a href="/Signin" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Sign in</a>
          <a href="/Signup" class="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</a>
        </div>
