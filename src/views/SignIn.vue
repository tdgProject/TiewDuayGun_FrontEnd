  ...
  <div class="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12">
   <span class="font-normal">Sign In</span>
    <form class="" @submit.prevent="login">
      ...
      <input id="password-confirm" type="password" v-model="password" placeholder="Password" autocomplete="new-password" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
      <button type="submit" class="w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none">
        Sign in
      </button>
    </form>
    <div class="text-left p-2">
      <router-link class="text-black mt-2" :to="'Signup'">Don't have any Id?</router-link>
    </div>
    <div
        v-if="message"
